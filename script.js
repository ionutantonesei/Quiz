...
fetch('http://localhost:3000/toate').then(response =>{
    ...
    buton1.addEventListener('click',()=>{
        ...
        else if(validareButon1 == 1 && data[i].raspunsuri[0][1] == null) corect = 0;
    });
    buton2.addEventListener('click',()=>{
        ...
        else if (validareButon2 == 1 && data[i].raspunsuri[1][1] == null) corect = 0;
    });
    buton3.addEventListener('click',()=>{
        ...
        else if(validareButon3 == 1 && data[i].raspunsuri[2][1] == null) corect = 0;
    });
    buton4.addEventListener('click',()=>{
        ...
        else if(validareButon4 == 1 && data[i].raspunsuri[3][1] == null) corect = 0;
    });
