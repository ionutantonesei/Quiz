...
fetch('http://localhost:3000/toate').then(response =>{
    ...
    console.log(data[0].raspunsuri[0][0]+' '+data[0].raspunsuri[0][1]);
    console.log(data[0].raspunsuri[1][0]+' '+data[0].raspunsuri[0][1]);
    console.log(data[0].raspunsuri[2][0]+' '+data[0].raspunsuri[0][1]);
    console.log(data[0].raspunsuri[3][0]+' '+data[0].raspunsuri[0][1]);
